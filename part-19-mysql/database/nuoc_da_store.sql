...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 05, 2026 at 11:24 AM
...
--
CREATE DATABASE IF NOT EXISTS `nuoc_da_store` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `nuoc_da_store`;
...
CREATE TABLE `products` (
  ...
  `product_thumb` varchar(500) NOT NULL,
  `product_price` decimal(15,2) NOT NULL,
...
--
ALTER TABLE `products`
  ADD CONSTRAINT `fk_products_categories` FOREIGN KEY (`cat_id`) REFERENCES `categories` (`id`);
COMMIT;
